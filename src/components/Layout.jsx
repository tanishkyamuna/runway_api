...
import { Menu, X, ChevronDown, Play, Mail, Phone, MapPin, Facebook, Twitter, Linkedin, LogIn, UserPlus, Settings, TrendingUp } from 'lucide-react';
          ...
          <div>
            ...
            <div className="mt-6 space-y-2">
              <div className="flex flex-col space-y-2">
                ...
                <Link to="/influencer/login" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <TrendingUp className="w-4 h-4" />
                  Influencer Login
                </Link>
                <Link to="/admin/login" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
